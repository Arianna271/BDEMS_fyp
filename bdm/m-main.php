...
$tot_approve	= numRows($con, "SELECT * FROM `eventorganiser` WHERE `status` = 'Approved' ");
$tot_pending	= numRows($con, "SELECT * FROM `eventorganiser` WHERE `status` = 'Pending' ");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="w3-large w3-sidebar w3-bar-block w3-collapse w3-maroon w3-card" style="z-index:3;width:250px;" id="mySidebar">
	...
	<a href="m-main.php" class="w3-padding-16 w3-bar-item w3-button w3-dark-maroon">
	...
	<div class="w3-containerx w3-content  w3-padding-16 " style="max-width:1200px;">    
		...
		<div class="w3-row">
			...
			<div class="w3-col m3 w3-container w3-padding">
				...
				ORGANISER REQUEST <br>
				</div>
			</div>
			
			<div class="w3-col m3 w3-container w3-padding">
				<div class="w3-card w3-border w3-maroon w3-center w3-round-xlarge w3-margin w3-padding w3-padding-16">
				<div class="w3-row"><i class="fa fa-fw fa-check fa-2x w3-left"></i></div>
				<h1><b><?PHP echo $tot_approve;?></b></h1>
				ORGANISER APPROVED <br>
				</div>
			</div>
			
			<div class="w3-col m3 w3-container w3-padding">
				<div class="w3-card w3-border w3-maroon w3-center w3-round-xlarge w3-margin w3-padding w3-padding-16">
				<div class="w3-row"><i class="fa fa-fw fa-hourglass-half fa-2x w3-left"></i></div>
				<h1><b><?PHP echo $tot_pending;?></b></h1>
				ORGANISER PENDING <br>
				</div>
			</div>
