...
if($act == "login")
{	
	$SQL_login 	= " SELECT * FROM `admin` WHERE `username` = '$username' AND `passwordAdmin` = '$passwordAdmin' ";
	...
	if($valid > 0)
	{
		...
		header("refresh:2;url=a-login.php");
	}
}
?>
<!DOCTYPE html>
		...
		<div class="w3-content w3-container w3-large" style="max-width:800px">			
			...
			<form action="" method="post" class="">
				...
				<div class="w3-section">
					...
					<input class="w3-input w3-border w3-round-large cpwdx" type="password" name="passwordAdmin" id="passwordAdmin" placeholder="" required>
