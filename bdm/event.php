...
<div class="w3-black" id="contact">
	<div class="w3-content w3-container w3-white" style="background-image: url(images/map.png); max-width:1400px">
		<div class="w3-content w3-container w3-large w3-center" style="max-width:1100px">	
			<div class="w3-padding-64"></div>
			<h3>Let's Start by Finding a</h3>
			<div class="tajuk" style="font-size:40px; font-weight:500"><b>Location Near You</b></div>
			<div class="w3-padding-16"></div>
			<form method="post" action="event-search.php?page=event" >								
